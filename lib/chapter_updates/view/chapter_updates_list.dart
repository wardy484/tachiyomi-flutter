...
class ChapterUpdatesList extends ConsumerStatefulWidget {
  const ChapterUpdatesList({Key? key}) : super(key: key);

  @override
  _ChapterUpdatesListState createState() => _ChapterUpdatesListState();
}

class _ChapterUpdatesListState extends ConsumerState<ChapterUpdatesList> {
  @override
  void initState() {
    super.initState();
