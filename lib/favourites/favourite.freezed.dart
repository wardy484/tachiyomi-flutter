...
class _$FavouriteCopyWithImpl<$Res> implements $FavouriteCopyWith<$Res> {
  ...
  $ChapterCopyWith<$Res>? get lastChapterRead {
    ...
    return $ChapterCopyWith<$Res>(_value.lastChapterRead!, (value) {
      return _then(_value.copyWith(lastChapterRead: value));
    });
  }
}
...
class _$_Favourite extends _Favourite {
  ...
  final List<TagSection> _tagSections;
  @override
  List<TagSection> get tagSections {
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_tagSections);
  }
  ...
  Map<String, dynamic> toJson() {
    return _$$_FavouriteToJson(this);
  }
}
